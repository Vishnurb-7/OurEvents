    ...
    return (
        ...
        <div className={`w-[100%] h-screen md:h-screen lg:h-screen bg-cover`} style={{ backgroundImage: `url(${image})` }}>
            ...
            <div className='grid grid-cols-2 h-[70%]'>
                ...
                <div className='w-full h-full text-black flex justify-center items-center font-Viaoda text-3xl md:text-6xl lg:text-5xl text-center'>From Venue Selection to Event Execution, We’re With You Every Step of the Way!</div>
